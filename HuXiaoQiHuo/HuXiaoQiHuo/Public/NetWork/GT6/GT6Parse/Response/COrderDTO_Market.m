...
@implementation COrderDTO_Market
@synthesize id,price,ip,user,mmcode,time,isbuy,number,oddnumber,adverse,matchid,modetype,udtype,loss,profit
...
-(NSString *)description
{
    ...
    return [NSString stringWithFormat:@"id:%d, price:%lf,ip:%@, user:%d, mmcode:%@ time:%@ isbuy:%@ number:%0.1f oddnumber:%d adverse:%@ matchid:%d modetype:%@ udtype:%@",
